...
class MPU9250(MPU6050):
    ...
    1. optional device_addr 0, 1 depending on the voltage applied to pin AD0 (Drotek default is 1)
       if None driver will scan for a device (if one device only is on bus)
    2, 3. transposition, scaling optional 3-tuples allowing for outputs to be based on vehicle
    ...
    def __init__(self, device_addr=None, transposition=(0, 1, 2), scaling=(1, 1, 1), pins=None):

        super().__init__(device_addr, transposition, scaling, pins)
